...
def main() -> None:
    ...
    Fetches all Wger catalog data and upserts it into the PostgreSQL database.
    """
    try:
        dal = PostgresDal()
        total = 0
        ...
        # Categories, Equipment, and Muscles must exist before Exercises can reference them.
