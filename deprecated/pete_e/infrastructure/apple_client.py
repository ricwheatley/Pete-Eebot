# (Functional) Apple Health data parser – processes Apple Health export ZIPs and persists daily summaries via the DataAccess interface:. If no DAL is provided, it instantiates a Postgres DAL on the fly.  
