# (Functional) Logging configuration – sets up a rotating file logger (up to 5 MB, 5 backups) and a console handler. Provides `log_message(msg, level)` for uniform log output.
